<template>
  <div class="meta-container rounded-2 border border-1 p-3">
    ...
    <div class="row" v-if="inMetadataEditMode">
      <p><input class="form-control" type="text" name="zim-title" required v-model="archiveMetadataFormModal.title" placeholder="ZIM Title metadata" /></p>
      <p><input class="form-control" type="text" name="zim-description" required v-model="archiveMetadataFormModal.description" placeholder="ZIM Description metadata" /></p>
      <p><input class="form-control" type="text" name="zim-name" required v-model="archiveMetadataFormModal.name" placeholder="ZIM Name metadata" /></p>
      ...
      <p><input class="form-control" type="text" name="zim-creator" required v-model="archiveMetadataFormModal.creator" placeholder="ZIM Creator metadata" /></p>
      <p><input class="form-control" type="text" name="zim-lang" required v-model="archiveMetadataFormModal.languages" placeholder="ZIM Language metadata" /></p>
      <p><smart-tagz
            autosuggest
            editable
      ...
      <p><input class="form-control" type="text" required name="zim-filename" v-model="archiveMetadataFormModal.filename" placeholder="ZIM Filename" /></p>
    </div>
