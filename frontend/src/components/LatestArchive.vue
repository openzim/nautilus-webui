<template>
  <div style="text-align: center;">
    <div v-if="canBeDownloaded">
      <a :href="props.archive.download_url" download>[Download {{ props.archive.config.filename }} ({{ archiveFileSize }})]</a>
      <br />
      <span>created on {{ formattedDate(props.archive.created_on) }}</span>
    </div>
    <div v-else>
      <span class="unavail-zim">[Download {{ props.archive.config.filename }} ({{ archiveFileSize }} of files]</span>
      <br />
